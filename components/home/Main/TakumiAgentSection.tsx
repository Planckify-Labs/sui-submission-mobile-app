...
const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    label: "Earn yield",
    sample: "earn on USDC",
    prompt: "Earn yield on my idle USDC/USDT",
    icon: TrendingUp,
    variant: "light",
  },
  {
...
// these are one-tap *informational* asks the cards don't cover.
const QUICK_PROMPTS: {
  id: string;
  label: string;
  prompt: string;
  ...
  },
  {
    id: "prices",
    label: "Prices",
    prompt: "What are current token prices?",
    icon: LineChart,
  },
  {
    id: "portfolio",
...
>(({ onAsk, onOpenAgentChat, onVoiceFocus }, ref) => {
